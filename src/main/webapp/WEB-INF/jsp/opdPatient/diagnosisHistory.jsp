        ...
        <div class="main-content">
            <form id="opdForm" action="#" method="get">
             <div class="row">
                ...
                <div class="col-md-4 mb-3">
                    <label for="diagnosisHistory">Diagnosis Type</label>
                ...
                <div class="col-md-4 d-flex align-items-end mb-3">
                    <button type="submit" class="btn btn-warning btn-sm add-btn" id="submitDiagnosisButton">Submit</button>
                </div>
                </div>
            </form>
    ...
    $(document).ready(function () {
        $('#opdForm').on('submit', function (e) {
            ...
            if (todayrecord && disease) {
                getPatientData(todayrecord, disease);
            } else {
                alert("Please select both patient type and disease type.");
            }
        });

        function getPatientData(todayrecord, disease) {
            $.ajax({
                type: 'GET',
                ...
                success: function (data) {
                    ...
                    if (data.length === 0) {
                        ...
                        tableHtml = '<table border="1" style="width: 100%; font-size: 18px;"><thead><tr><th>Name</th><th>Phone Number</th><th>Treatment Date</th><th>Seen By Doctor</th><th>Diagnosis</th></tr></thead><tbody>';
                        data.forEach(function (item) {
                            ...
                            tableHtml += '<td>' + item.diagnosis.diagnosis + '</td>';
                            tableHtml += '</tr>';
                        });
